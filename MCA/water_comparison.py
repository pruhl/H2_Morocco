...
gdf_water_50_50.plot(column='sum', cmap = 'turbo_r', legend = True, vmin=0, vmax=50, ax = axs[0])
axs[0].set_title('2025')

gdf_water_50_50_2050.plot(column='sum', cmap = 'turbo_r', legend = True, vmin=0, vmax=50, ax = axs[1])
axs[1].set_title('2050')

# Plots with 50/50 rating of water residual and water availability V2
fig, axs = plt.subplots(1, 2, figsize = (10,5))
fig.suptitle('Wateranalysis (50/50 rating) for 2025 and 2050 V2')
gdf_water_50_50_V2.plot(column='sum', cmap = 'RdBu', legend = True, vmin=0, vmax=gdf_water_50_50['sum'].max(), ax = axs[0])
axs[0].set_title('2025')

gdf_water_50_50_2050_V2.plot(column='sum', cmap = 'RdBu', legend = True, vmin=0, vmax=gdf_water_50_50['sum'].max(), ax = axs[1])
axs[1].set_title('2050')

# Plots with 50/50 rating of water residual and water availability V3
fig, axs = plt.subplots(1, 2, figsize = (10,5))
fig.suptitle('Wateranalysis (50/50 rating) for 2025 and 2050 V3')
gdf_water_50_50_V3.plot(column='sum', cmap = 'RdBu', legend = True, vmin=0, vmax=gdf_water_50_50['sum'].max(), ax = axs[0])
axs[0].set_title('2025')

gdf_water_50_50_2050_V3.plot(column='sum', cmap = 'RdBu', legend = True, vmin=0, vmax=gdf_water_50_50['sum'].max(), ax = axs[1])
axs[1].set_title('2050')