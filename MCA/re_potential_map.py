...
plt.title('Photovoltaic specific yield Morocco', fontsize = 15)
plt.axis('off')
cbar_ax = fig.axes[-1]
cbar_ax.tick_params(labelsize=12)
cbar_ax.yaxis.label.set_size(14)
# plt.savefig("morocco_photovoltaic_potential.pdf", format="pdf", dpi=300)
plt.show()
...
cx.add_basemap(ax, crs=gdf_morocco_boundary.crs, source=cx.providers.CartoDB.Positron)
plt.title('Wind full load hours Morocco', fontsize = 15)
plt.axis('off')
cbar_ax = fig.axes[-1]
cbar_ax.tick_params(labelsize=12)
cbar_ax.yaxis.label.set_size(14)
# plt.savefig("morocco_wind_potential.pdf", format="pdf", dpi=300)
plt.show()